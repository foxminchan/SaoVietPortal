...
using Portal.Shared.Infrastructure.Health.HealthChecks;
using Portal.Shared.Infrastructure.Persistence;

namespace Portal.Shared.Infrastructure.Health;
...
public static class Extension
{
    public static void AddHealthCheck(this WebApplicationBuilder builder)
    {
        builder.Services.AddHealthChecks()
            ...
            .AddDbContextCheck<ApplicationDbContextBase>(tags: new[] { "db context" })
